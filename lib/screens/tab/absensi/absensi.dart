...
class _AbsensiTabState extends State<AbsensiTab> {
  ...
  Widget renderBody(BuildContext context, Staff staffSession) {
    ...
    return ListView(
      ...
      children: [
        ...
        if (queryPresensi != null && selectedUnitKerja != null)
          AbsensiTable(
              unitKerja: selectedUnitKerja!,
  ...
  void actionSubmit() {
    ...
    queryStaff.where('is_aktif', isEqualTo: true).get().then((snapshot) {
    ...
    queryPresensi = FirebaseFirestore.instance.collection('presensi');
    queryPresensi = queryPresensi!
